...
import handwritting.utils.TrainArguments;
...
public class Training {
    private static String datasetMainDir = "src/main/resources/datasets/hand-writting-dataset";
    private static String lettersMainDir = "src/main/resources/letters";
    private static String test = "test";
    private static String train = "train";
    private static String testDir = "test_v2/test";
    private static String trainDir = "train_v2/train";
    private static String testCsvFile = "written_name_test_v2.csv";
    private static String trainCsvFile = "written_name_train_v2.csv";
    private static String unwantedPartPath = "src/main/resources/test/nomTemplate.png";
